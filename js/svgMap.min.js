...
! function n(s, a, r) {
    function h(t, l) {
        if (!a[t]) {
            ...
            s[t][0].call(i.exports, function(l) {
                return h(s[t][1][l] || l)
            }, i, i.exports, n, s, a, r)
        }
        return a[t].exports
    ...
    1: [function(l, t, e) {
        var n = l("./svg-utilities");
        t.exports = {
            enable: function(l) {
                var t = l.svg.querySelector("defs");
                if (t || (t = document.createElementNS(n.svgNS, "defs"), l.svg.appendChild(t)), !t.querySelector("style#svg-pan-zoom-controls-styles")) {
                    var e = document.createElementNS(n.svgNS, "style");
                ...
                var o = document.createElementNS(n.svgNS, "g");
            ...
            _createZoomIn: function(l) {
                ...
                var e = document.createElementNS(n.svgNS, "rect");
    ...
    2: [function(l, t, e) {
        ...
        }, i.prototype.computeRelativeZoom = function(l) {
            ...
            if (t || e) {
                if (t && (!1 === this.options.beforeZoom(this.getRelativeZoom(), this.computeRelativeZoom(l.a)) ? (l.a = l.d = this.activeState.zoom, t = !1) : (this.updateCache(l), this.options.onZoom(this.getRelativeZoom()))), e) {
                    var o = this.options.beforePan(this.getPan(), {
                        ...
                        i = !1,
                        n = !1;
                    !1 === o ? (l.e = this.getPan().x, l.f = this.getPan().y, i = n = !0) : s.isObject(o) && (!1 === o.x ? (l.e = this.getPan().x, i = !0) : s.isNumber(o.x) && (l.e = o.x), !1 === o.y ? (l.f = this.getPan().y, n = !0) : s.isNumber(o.y) && (l.f = o.y)), i && n || !this.isPanDifferent(l) ? e = !1 : (this.updateCache(l), this.options.onPan(this.getPan()))
                }(t || e) && this.updateCTMOnNextFrame()
            }
        }, i.prototype.isZoomDifferent = function(l) {
            return this.activeState.zoom !== l.a
        }, i.prototype.isPanDifferent = function(l) {
            return this.activeState.x !== l.e || this.activeState.y !== l.f
        }, i.prototype.updateCache = function(l) {
    ...
    4: [function(l, t, e) {
        ...
        i.prototype.init = function(l, t) {
            ...
            i.setBeforeZoom(this.options.beforeZoom), i.setOnZoom(this.options.onZoom), i.setBeforePan(this.options.beforePan), i.setOnPan(this.options.onPan), i.setOnUpdatedCTM(this.options.onUpdatedCTM), this.options.controlIconsEnabled && n.enable(this), this.lastMouseWheelEventTime = Date.now(), this.setupHandlers()
            ...
            for (var i in this.eventListeners)(this.options.eventsListenerElement || this.svg).addEventListener(i, this.eventListeners[i], !this.options.preventMouseEventsDefault && L);
        ...
        }, i.prototype.handleMouseWheel = function(l) {
            if (this.options.zoomEnabled && "none" === this.state) {
                ...
                var i = this.svg.getScreenCTM().inverse(),
                    n = a.getEventPoint(l, this.svg).matrixTransform(i),
                    s = Math.pow(1 + this.options.zoomScaleSensitivity, -1 * t);
                this.zoomAtPoint(s, n)
            }
        }, i.prototype.zoomAtPoint = function(l, t, e) {
            ...
            var i = this.viewport.getCTM(),
                n = t.matrixTransform(i.inverse()),
                s = this.svg.createSVGMatrix().translate(n.x, n.y).scale(l).translate(-n.x, -n.y),
                a = i.multiply(s);
            a.a !== i.a && this.viewport.setCTM(a)
        }, i.prototype.zoom = function(l, t) {
            this.zoomAtPoint(l, a.getSvgCenterPoint(this.svg, this.width, this.height), t)
        }, i.prototype.publicZoom = function(l, t) {
            t && (l = this.computeFromRelativeZoom(l)), this.zoom(l, t)
        }, i.prototype.publicZoomAtPoint = function(l, t, e) {
        ...
        }, i.prototype.computeFromRelativeZoom = function(l) {
        ...
        }, i.prototype.handleDblClick = function(l) {
            var t;
        ...
        }, i.prototype.handleMouseDown = function(l, t) {
        ...
        }, i.prototype.handleMouseMove = function(l) {
        ...
        }, i.prototype.handleMouseUp = function(l) {
            ...
            this.disableMouseWheelZoom(), this.getPublicInstance().disableControlIcons(), this.reset(), p = p.filter(function(l) {
                return l.svg !== t.svg
            ...
            return this.publicInstance || (this.publicInstance = this.pi = {
                ...
                enableControlIcons: function() {
                    return e.options.controlIconsEnabled || (e.options.controlIconsEnabled = !0, n.enable(e)), e.pi
                },
                disableControlIcons: function() {
                    return e.options.controlIconsEnabled && (e.options.controlIconsEnabled = !1, n.disable(e)), e.pi
                },
        ...
        t.exports = function(l, t) {
            ...
            for (var o = p.length - 1; 0 <= o; o--)
                if (p[o].svg === e) return p[o].instance.getPublicInstance();
            return p.push({
                svg: e,
                instance: new i(e, t)
            }), p[p.length - 1].instance.getPublicInstance()
        }
    }, {
        "./control-icons": 1,
        "./shadow-viewport": 2,
    ...
    5: [function(l, t, e) {
        var r = l("./utilities"),
            n = "unknown";
        document.documentMode && (n = "ie"), t.exports = {
            ...
            getOrCreateViewport: function(l, t) {
                ...
                if (!e) {
                    ...
                    (e = document.createElementNS(this.svgNS, "g")).setAttribute("id", i);
                    var n = l.childNodes || l.children;
                    if (n && 0 < n.length)
                        for (var s = n.length; 0 < s; s--) "defs" !== n[n.length - s].nodeName && e.appendChild(n[n.length - s]);
                    l.appendChild(e)
                }
                var a = [];
            ...
            setCTM: function(l, t, e) {
                ...
                l.setAttributeNS(null, "transform", i), "transform" in l.style ? l.style.transform = i : "-ms-transform" in l.style ? l.style["-ms-transform"] = i : "-webkit-transform" in l.style && (l.style["-webkit-transform"] = i), "ie" === n && e && (e.parentNode.insertBefore(e, e), window.setTimeout(function() {
                    o.refreshDefsGlobal()
    ...
    6: [function(l, t, e) {
        t.exports = function() {
            ...
            function o(l, t, e, o) {
                var i, n, s, a;
                i = "wheel" === h ? e : (n = l, s = e, a = function(l) {
                    !l && (l = window.event);
                    var t = {
                        originalEvent: l,
            ...
            function i(l, t, e, o) {
                var i;
                i = "wheel" === h ? e : function(l) {
                        for (var t = 0; t < p.length; t++)
                            if (p[t].element === l) return p[t].fn;
                        return function() {}
                    }(l), l[n](L + t, i, !!o && u),
                    function(l) {
                        for (var t = 0; t < p.length; t++)
                            if (p[t].element === l) return p.splice(t, 1)
                    }(l)
            }
            return window.addEventListener ? (r = "addEventListener", n = "removeEventListener") : (r = "attachEvent", n = "detachEvent", L = "on"), h = "onwheel" in document.createElement("div") ? "wheel" : void 0 !== document.onmousewheel ? "mousewheel" : "DOMMouseScroll", {
                on: function(l, t, e) {
                    o(l, h, t, e), "DOMMouseScroll" == h && o(l, "MozMousePixelScroll", t, e)
                },
                off: function(l, t, e) {
                    i(l, h, t, e), "DOMMouseScroll" == h && i(l, "MozMousePixelScroll", t, e)
                }
            }
        }()
    }, {}],
    7: [function(l, t, e) {
        ...
        t.exports = {
            ...
            throttle: function(e, o, i) {
                var n, s, a, r = this,
                    h = null,
                    L = 0;
                i || (i = {});
                var p = function() {
                    L = !1 === i.leading ? 0 : r.now(), h = null, a = e.apply(n, s), h || (n = s = null)
                };
                return function() {
                    var l = r.now();
                    L || !1 !== i.leading || (L = l);
                    var t = o - (l - L);
                    return n = this, s = arguments, t <= 0 || o < t ? (clearTimeout(h), h = null, L = l, a = e.apply(n, s), h || (n = s = null)) : h || !1 === i.trailing || (h = setTimeout(p, t)), a
                }
            },
...
svgMap.prototype.init = function(l) {
        ...
        ZM: "Zambia",
        ZW: "Zimbabwe"
    }, svgMap.prototype.applyData = function(n) {
        var s = null,
            a = null;
        Object.keys(n.values).forEach(function(l) {
            var t = parseInt(n.values[l][n.applyData], 10);
            null === s && (s = t), null === a && (a = t), s < t && (s = t), t < a && (a = t)
        }), n.data[n.applyData].thresholdMax && (s = Math.min(s, n.data[n.applyData].thresholdMax)), n.data[n.applyData].thresholdMin && (a = Math.max(a, n.data[n.applyData].thresholdMin)), Object.keys(this.countries).forEach(function(l) {
            var t = document.getElementById(this.id + "-map-country-" + l);
            if (t)
                if (n.values[l]) {
                    var e = Math.max(a, parseInt(n.values[l][n.applyData], 10)),
                        o = Math.max(0, Math.min(1, (e - a) / (s - a))),
                        i = this.getColor(this.options.colorMax, this.options.colorMin, o);
                    t.setAttribute("fill", i)
                } else t.setAttribute("fill", this.options.colorNoData)
        }.bind(this))
    }, svgMap.prototype.emojiFlags = {}, svgMap.prototype.createMap = function() {
        ...
        this.options.countries.EH || (t.MA.d = t["MA-EH"].d, delete t.EH), delete t["MA-EH"], Object.keys(t).forEach(function(l) {
            ...
            if (t.d) {
                ...
                e.setAttribute("d", t.d), e.setAttribute("id", this.id + "-map-country-" + l), e.setAttribute("data-id", l), e.classList.add("svgMap-country"), this.mapImage.appendChild(e), ["mouseenter", "touchdown"].forEach(function(l) {
                    ...
                    var t = e.getAttribute("data-id");
                    this.setTooltipContent(this.getTooltipContent(t)), this.showTooltip(l)
                }.bind(this)), e.addEventListener("touchmove", function(l) {
                    this.mobileMoveTooltip(l)
                }.bind(this)), e.addEventListener("touchend", function() {
                    this.hideTooltip()
                }.bind(this))
            }
        }.bind(this));
        ...
        this.mapPanZoom = svgPanZoom(this.mapImage, {
            ...
            beforePan: function(l, t) {
                var e = .85 * h.mapWrapper.offsetWidth,
                    ...
                    i = this.getSizes(),
                    n = -(i.viewBox.x + i.viewBox.width) * i.realZoom + e,
                    s = i.width - e - i.viewBox.x * i.realZoom,
                    a = -(i.viewBox.y + i.viewBox.height) * i.realZoom + o,
                    r = i.height - o - i.viewBox.y * i.realZoom;
                return {
                    x: Math.max(n, Math.min(s, t.x)),
    ...
    }, svgMap.prototype.mobileShowTooltip = function(l) {
        this.tooltip.classList.add("svgMap-active"), this.mobileMoveTooltip(l)
        ...
        var t = l.pageX,
            e = l.pageY,
            o = window.innerWidth,
            i = this.tooltip.offsetWidth,
            n = this.tooltip.offsetHeight,
            s = t - i / 2;
        this.tooltipPointer.style.marginLeft = s <= 6 ? (t = 6 + i / 2, s - 6 + "px") : o - 6 <= s + i ? (t = o - 6 - i / 2, -1 * (o - 6 - l.pageX - i / 2) + "px") : "0px", e - 12 - n <= 6 ? (this.tooltip.classList.add("svgMap-tooltip-flipped"), e += 32) : (this.tooltip.classList.remove("svgMap-tooltip-flipped"), e -= 12), this.tooltip.style.left = t + "px", this.tooltip.style.top = e + "px"
    }, svgMap.prototype.mobileMoveTooltip = function(l) {
        if (!l.pageX && !l.pageY) {
            var t = event.changedTouches[0].clientX,
        ...
        var o = Math.ceil(parseInt(l.substring(0, 2), 16) * e + parseInt(t.substring(0, 2), 16) * (1 - e)),
            ...
            n = Math.ceil(parseInt(l.substring(4, 6), 16) * e + parseInt(t.substring(4, 6), 16) * (1 - e));
        return "#" + this.getHex(o) + this.getHex(i) + this.getHex(n)
