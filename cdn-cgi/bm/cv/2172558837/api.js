! function(n) {
    ...
    (function(r) {
        ...
        ! function() {
            ...
            function f(n, t) {
                for (var e, r = t ? "0123456789ABCDEF" : "0123456789abcdef", o = "", i = 0, h = n.length; i < h; i += 1) e = n.charCodeAt(i), o += r.charAt(e >>> 4 & 15) + r.charAt(15 & e);
                return o
            }
            ...
            i = {
                ...
                Base64: function() {
                    ...
                    this.encode = function(r) {
                        ...
                        do {
                            i = (c = n.indexOf(r.charAt(o += 1)) << 18 | n.indexOf(r.charAt(o += 1)) << 12 | (a = n.indexOf(r.charAt(o += 1))) << 6 | (f = n.indexOf(r.charAt(o += 1)))) >> 16 & 255, h = c >> 8 & 255, u = 255 & c, B[l += 1] = 64 === a ? String.fromCharCode(i) : 64 === f ? String.fromCharCode(i, h) : String.fromCharCode(i, h, u)
                        } while (o < r.length);
                ...
                MD5: function(n) {
                    ...
                    function o(n) {
                        return l(c(C(n = r ? h(n) : n), 8 * n.length))
                    }

                    function i(n, t) {
                        var e, o, i, u, a;
                        for (n = r ? h(n) : n, t = r ? h(t) : t, (e = C(n)).length > 16 && (e = c(e, 8 * n.length)), o = Array(16), i = Array(16), a = 0; a < 16; a += 1) o[a] = 909522486 ^ e[a], i[a] = 1549556828 ^ e[a];
                        return u = c(o.concat(C(t)), 512 + 8 * t.length), l(c(i.concat(u), 640))
                    }
                    ...
                    function B(n, t, e, r, o, i) {
                        return u(a(u(u(t, n), u(r, i)), o), e)
                    }

                    function d(n, t, e, r, o, i, h) {
                        return B(t & e | ~t & r, n, t, o, i, h)
                    }

                    function A(n, t, e, r, o, i, h) {
                        return B(t & r | e & ~r, n, t, o, i, h)
                    }

                    function w(n, t, e, r, o, i, h) {
                        return B(t ^ e ^ r, n, t, o, i, h)
                    }

                    function F(n, t, e, r, o, i, h) {
                        return B(e ^ (t | ~r), n, t, o, i, h)
                    }
                    this.hex = function(n) {
                        return f(o(n), t)
                    }, this.b64 = function(n) {
                        ...
                        return "boolean" == typeof n && (r = n), this
                    }
                },
                SHA1: function(n) {
                    var t = !(!n || "boolean" != typeof n.uppercase) && n.uppercase,
                    ...
                    function o(n) {
                        return c(l(B(n = r ? h(n) : n), 8 * n.length))
                    }

                    function i(n, t) {
                        var e, o, i, u, a;
                        for (n = r ? h(n) : n, t = r ? h(t) : t, (e = B(n)).length > 16 && (e = l(e, 8 * n.length)), o = Array(16), i = Array(16), u = 0; u < 16; u += 1) o[u] = 909522486 ^ e[u], i[u] = 1549556828 ^ e[u];
                        return a = l(o.concat(B(t)), 512 + 8 * t.length), c(l(i.concat(a), 672))
                    }
                ...
                SHA256: function(n) {
                    ...
                    function o(n, t) {
                        return c(g(B(n = t ? h(n) : n), 8 * n.length))
                    }
                    ...
                    function A(n) {
                        return a(n, 2) ^ a(n, 13) ^ a(n, 22)
                    }

                    function w(n) {
                        return a(n, 6) ^ a(n, 11) ^ a(n, 25)
                    }

                    function F(n) {
                        return a(n, 7) ^ a(n, 18) ^ l(n, 3)
                    }
                    ...
                    this.hex = function(n) {
                        ...
                        return "boolean" == typeof n && n, this
                    }, this.setPad = function(n) {
                        return e = n || e, this
                    }, this.setUTF8 = function(n) {
                        return "boolean" == typeof n && (r = n), this
                ...
                SHA512: function(n) {
                    ...
                    function o(n) {
                        return c(u(B(n = r ? h(n) : n), 8 * n.length))
                    }
                ...
                RMD160: function(n) {
                    ...
                    function l(n) {
                        return d(A(C(n = e ? h(n) : n), 8 * n.length))
                    }
            ...
            }, t && "object" == typeof r && r && r.global, void 0 === (o = function() {
                return i
    ...
    function u(n) {
        return {
            r: h((function() {
                return [n.screen.width, n.screen.height]
            })),
            ar: h((function() {
                return [n.screen.availHeight, n.screen.availWidth]
            })),
    ...
    var r = e(1),
        o = r.render,
        i = r.hash;
    var h = window.performance && performance.now ? function() {
    ...
    ! function(n) {
        ...
        if ("loading" !== document.readyState) e();
            ...
            document.onreadystatechange = function() {
                r(), "loading" !== document.readyState && (document.onreadystatechange = r, e())
            }
        }
    }((function() {
